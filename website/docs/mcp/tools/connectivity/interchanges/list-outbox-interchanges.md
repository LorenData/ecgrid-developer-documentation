---
title: list-outbox-interchanges
sidebar_position: 3
---
...
2026-07-07: list-outbox-interchanges tool reference - Greg Kolinski
*/}

# list-outbox-interchanges
...
`connectivity_interchange_list-outbox-interchanges`
...
| `request.blocked` | boolean | No | Switch to the BLOCKED view — held outbound interchanges. Default false. |
...
Returns `interchanges` (same per-row shape as `get-interchange-by-id`) plus pagination fields. Pagination fields are `0` for the non-paged flag views (`blocked`, `pending`, `noRoute`).
  ...
  "interchanges": [
    {
      ...
      "interchangeControlId": "000067890",
      "standard": "X12",
      "documentType": "850",
      "bytes": 1536,
      "interchangeDateTime": "2026-04-15T09:15:00Z",
      "processDate": "2026-04-15T09:15:10Z",
      "status": {
        "code": 4000,
        "description": "Complete: CLOSED",
        "statusDate": "2026-04-15T09:15:45Z"
      },
      "from": {
        "networkId": 7,
      ...
      "header": "ISA*00*          *00*          *ZZ*ACMECORP       *ZZ*BUYERCORP      *260415*0915*^*00501*000067890*0*P*>~",
      "tpFrom": {
        "ecgridId": 6928311,
        "qualifier": "ZZ",
        "id": "ACMECORP",
...
```json
{
  ...
  "method": "tools/call",
  "params": {
    "name": "connectivity_interchange_list-outbox-interchanges",
    "arguments": {
      "request": {
        "networkId": 7,
        "mailboxId": 142,
...
- `List all outbound interchanges from mailbox 142 in April 2026`
- `Are there any undeliverable outbound interchanges for mailbox 142?`
- `Show me all 810 invoices sent from mailbox 142 last week`
...
- [list-inbox-interchanges](./list-inbox-interchanges.md) — list inbound interchanges received by a mailbox
...
- [check-partner-config](../partners/check-partner-config.md) — diagnose routing issues for undeliverable interchanges
