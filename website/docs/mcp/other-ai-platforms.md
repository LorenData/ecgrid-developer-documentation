...
2026-07-20: Update auth header reference - Greg Kolinski
*/}
...
The REST API uses the same ECGrid API key (`X-Connectivity-API-Key` header) and covers the full breadth of ECGrid operations.
