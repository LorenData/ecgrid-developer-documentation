---
title: InterchangeOutBox
sidebar_position: 2
---
{/* AI Attribution — Loren Data AI Use Policy §8.2 | Tool: Claude Code (Anthropic) | 2026-05-07: Created SOAP InterchangeOutBox method documentation page - Greg Kolinski
...
The SOAP API is in maintenance mode. For new integrations use the [REST equivalent](../../rest-api/interchanges/outbox-list.md).
:::
...
| `Created` | datetime | Timestamp when the interchange was sent (UTC) |
...
var result = port.InterchangeOutBox(sessionID /*, additional params */);
...
const [result] = await client.InterchangeOutBoxAsync({
  SessionID: sessionId,
  // additional params
});
console.log(result);
...
result = client.service.InterchangeOutBox(
...
See [Interchange Outbox List](../../rest-api/interchanges/outbox-list.md).
