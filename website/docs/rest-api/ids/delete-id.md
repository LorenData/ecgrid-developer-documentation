...
sidebar_position: 4
---
{/* AI Attribution — Loren Data AI Use Policy §8.2 | Tool: Claude Code (Anthropic) | 2026-05-07: Create DELETE /v2/ids/{id} REST API reference page - Greg Kolinski
...
|---|---|---|---|
| `id` | integer | Yes | The numeric ECGrid ID to terminate |
...
```csharp
// .NET 10 — terminate an ECGrid ID; confirm intent before calling in production
using var client = httpClientFactory.CreateClient("ECGrid");

var response = await client.DeleteAsync(
    $"https://rest.ecgrid.io/v2/ids/{ecGridId}");
response.EnsureSuccessStatusCode();

var result = await response.Content.ReadFromJsonAsync<ApiResponse<bool>>();
Console.WriteLine($"Terminated: {result!.Data}");
```
...
- [Get ID](get-id)
- [Update ID](update-id)
- [Delete Partner (Interconnect)](../partners/delete-partner)
